...
properties = {
    ...
    'level1': {
        ...
        'artificial 2': {
            'color': 'tab:red', 'linestyle': 'solid', 'xpos': 5},
        'artificial 1': {
            'color': 'tab:blue', 'linestyle': 'solid', 'xpos': 4},
        'natural silhouette': {
            'color': 'tab:brown', 'linestyle': 'solid', 'xpos': 3},
        'natural': {
            'color': 'tab:green', 'linestyle': 'solid', 'xpos': 1},
        'natural mix': {
            'color': 'tab:orange', 'linestyle': 'solid', 'xpos': 2},
    },
    'level2': {
        'CORnet-S+\nclassification': {
