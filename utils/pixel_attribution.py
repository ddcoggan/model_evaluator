...
from .get_trained_model import get_trained_model, reorg_dict, now
from utils.benchmarks.occlusion_behavioral_exp1 import load_trials, list_images
...
from DNN.utils import get_activations, CustomDataset
...
from in_vivo.behavioral.exp2.analysis import (
    NUM_TRIALS, NUM_FRAMES, FRAME_BATCHES, STIM_IDS, VISIBILITIES)
np.random.seed(42)
...
def load_cam(model_dir, architecture, method):
    model = get_trained_model(model_dir, architecture).cuda()
